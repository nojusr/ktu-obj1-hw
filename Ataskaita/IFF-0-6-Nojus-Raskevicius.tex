...
\subsection{Dėstytojo pastabos}
\begin{itemize}
    \item[•]Nėra užduoties numerio.
    \item[]\textit{Pataisyta.}
    \item[•]Kodėl string didžioji pirma raidė metode public static List FindLongestWords(List input)?
    \item[]\textit{Klaida, kilus iš dvejopos kombinacijos tarp įpročio rašyti 'string' kintamuosius iš didžiosios raidės (nuo kitų progravamivmo kalbų) ir fakto, kad C\# kalboje žodis 'string' yra interpretuojamas kaip System.String (tats pats kas rašyti 'String'), todėl, objektyvaus skirtumo nėra ir man IDE jokių problemų nerašo.} \color{blue}\href{https://stackoverflow.com/questions/7074/what-is-the-difference-between-string-and-string-in-c}{Šaltinis}\color{black}
    \item[•]Kodėl yra sąlyga: output.Contains(input[j]) == false? Čia apie tą patį metodą?
    \item[]\textit{Ši salyga yra skirta tikrinti ar žodžis jau nėra įkeltas į 'output' sąrašą. T.y. žodžiai 'output' saraše nesikartoja. Nesu tikras ar tai yra reikalaujama užduotyje.}
    \item[•]Kodėl Char didžioji?
    \item[]\textit{Seku tokia pačią logiką kaip ir su String. Sarašų tipų aprašymuose String yra rašomi iš didžiosios raidės. }
\end{itemize}

\changemargin{0cm}{0cm}\textbf{Testo rezultatai: 2/3}\newline
\textbf{Savarankiško darbo rezultatai: 0/1}\newline
\textbf{Laboratorinio darbo įvertinimas: 5/7}\newline
\textbf{Galutinis įvertinimas: 8}\newline
...
Šie duoemnys tikrina visą programos veiklą. Didžiausio tiražo laikraštis turėtų turėti 20001 egzempliorių. Retuose leidiniuose turėtų būti
Visi žurnalai kurių pavadinimas prasideda su 'nature' ir viena knyga: 'katekizmas'. 'Technologija.csv' faile turėtų būti visi žurnalai kurių pavadinimas prasideda su žodžiu 'science'.
Bendruose leidiniuose turėti būti visos 'hario poterio' knygos ir visi 'kauno dienos' laikraščiai.

\begin{changemargin}{0cm}{0cm}
    \textbf{kaunas.txt:}
\end{changemargin}
\inputminted{text}{Assets/L5/t1-i1.txt}

\begin{changemargin}{0cm}{0cm}
    \textbf{kaunas2.txt:}
\end{changemargin}
\inputminted{text}{Assets/L5/t1-i2.txt}

\begin{changemargin}{0cm}{0cm}
    \textbf{vilnius.txt:}
\end{changemargin}
\inputminted{text}{Assets/L5/t1-i3.txt}

\textbf{Programos išvestis:}
\inputminted{text}{Assets/L5/t1-oCon.txt}

\textbf{RetiLeidiniai.csv}
\inputminted{text}{Assets/L5/t1-o1.txt}

\textbf{Technologija.csv}
\inputminted{text}{Assets/L5/t1-o2.txt}

\textbf{BendriLeidiniai.csv}
\inputminted{text}{Assets/L5/t1-o3.txt}

\subsection{Dėstytojo pastabos}

\changemargin{0cm}{0cm}\textbf{Testo rezultatai: ?/3}\newline
\textbf{Savarankiško darbo rezultatai: 0/1}\newline
\textbf{Laboratorinio darbo įvertinimas: ?/7}\newline
\textbf{Galutinis įvertinimas: ?}\newline
\newpage
